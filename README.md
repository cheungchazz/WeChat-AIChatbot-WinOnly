...
- [x] **高级版企微**：PC端的企微个人号消息通道，支持发送语音条等各种信息
- [x] **ntwork：**PC端的企微个人号消息通道，依赖 [ntwork](https://github.com/chazzjimel/ntwork)，限制[WeCom_4.0.8.6027版本](https://dldir1.qq.com/wework/work_weixin/WeCom_4.0.8.6027.exe)，**只能在Win平台运行项目**。
- [x] **ntchat** ：PC端的个微消息通道，依赖 [ntchat项目](https://github.com/billyplus/ntchat) ，最高支持Python310版本，限[WeChat3.6.0.18版本](https://github.com/tom-snow/wechat-windows-versions/releases/download/v3.6.0.18/WeChatSetup-3.6.0.18.exe)，**只能在Win平台运行项目**。
- [x] **ntchat专用插件**：[group_assistant](https://github.com/chazzjimel/group_assistant)：群聊助手插件，当前仅用于邀请好友进群，后续有空会增加多点功能。
...
>**2023.08.10：** 适配高级版企微（企微个人号）消息通道。
>
>**2023.08.08：** 适配ntwork（企微个人号）消息通道。
>
>**2023.07.25：** 适配ntchat消息通道，兼容[FastGPT](https://github.com/labring/FastGPT) API接口，直接修改open_ai_api_key和open_ai_api_base即可使用。
...
```bash
git clone https://github.com/chazzjimel/chatgpt-on-wechat
